...
/**
*	Модуль для отрисовки коробки, тестовый.
*/
module client.shaders.coneRayTracing;
...
*/
class ConeRayTracingRendererProg : CLKernelProgram
{
	...
	*/
	...
	vec3 lightPosition() @property
	{
		return lightPos;
	}
	
	void lightPosition(vec3 val) @property
	{
		lightPos = val;
	}
